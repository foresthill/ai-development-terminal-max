...
const en: Record<string, string> = {
  ...
  "toast.onlyOneProject": "only 1 project — open another with 📁 folder / ⎇ clone, then Alt+P switches",
  "tip.zoom": "Alt+Z",
...
const ja: Record<string, string> = {
  ...
  "toast.onlyOneProject": "プロジェクトは1つだけ — 📁フォルダ / ⎇clone で追加すると Alt+P で切替できます",
  "tip.zoom": "Alt+Z",
