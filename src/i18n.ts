...
const en: Record<string, string> = {
  ...
  "saves.saveAs": "Save current",
  "saves.placeholder": "slot name…",
  "saves.slots": "Saved slots — click a slot to LOAD it (replaces your current workspace)",
  ...
  "hint": "Alt+T new · Alt+←/→ focus · Alt+↑/↓ depth · Alt+Z zoom · Alt+R run · Alt+N term · Alt+B browser · Alt+P project · Alt+M macro",
...
const ja: Record<string, string> = {
  ...
  "btn.settings": "⚙ 設定",
  "btn.saves": "💾 セーブ",
  "tip.saves": "名前付きセーブスロット：ワークスペース全体を保存／読込",
  "btn.help": "? ヘルプ",
  "tip.help": "ヘルプ — 概念・ショートカット・ツールバー",
  "help.title": "ヘルプ",
  "saves.title": "セーブスロット",
  "saves.saveAs": "現在を保存",
  "saves.placeholder": "スロット名…",
  "saves.slots": "保存済みスロット — クリックで読込（現在のワークスペースを置き換え）",
  ...
  "hint": "Alt+T 追加 · Alt+←/→ 移動 · Alt+↑/↓ 奥行き · Alt+Z 拡大 · Alt+R 起動 · Alt+N 端末 · Alt+B ブラウザ · Alt+P プロジェクト · Alt+M 俯瞰",
